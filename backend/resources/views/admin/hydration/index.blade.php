...
@section('content')
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold">Hydration Management</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Avg Daily Intake</p>
                    <p class="text-2xl font-semibold text-gray-900" id="avgDailyIntake">-</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Goal Achievement</p>
                    <p class="text-2xl font-semibold text-gray-900" id="goalAchievement">-</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Missed Reminders</p>
                    <p class="text-2xl font-semibold text-gray-900" id="missedReminders">-</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <!-- Daily Intake Chart -->
        <div class="bg-white p-6 rounded-lg shadow">
            <h3 class="text-lg font-semibold mb-4">Daily Water Intake</h3>
            <canvas id="dailyIntakeChart" width="400" height="200"></canvas>
        </div>

        <!-- Goal Achievement Chart -->
        <div class="bg-white p-6 rounded-lg shadow">
            <h3 class="text-lg font-semibold mb-4">Goal Achievement Rate</h3>
    ...
    <div class="bg-white p-6 rounded-lg shadow mb-8">
        <h3 class="text-lg font-semibold mb-4">Weekly Hydration Trend</h3>
