...
@section('content')
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold">Medication Management</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900" id="adherenceRate">-</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Upcoming Doses</p>
                    <p class="text-2xl font-semibold text-gray-900" id="upcomingDoses">-</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Missed Doses</p>
                    <p class="text-2xl font-semibold text-gray-900" id="missedDoses">-</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            <h3 class="text-lg font-semibold mb-4">Medication Types Distribution</h3>
    ...
    <div class="bg-white p-6 rounded-lg shadow mb-8">
        <h3 class="text-lg font-semibold mb-4">Weekly Adherence Trend</h3>
