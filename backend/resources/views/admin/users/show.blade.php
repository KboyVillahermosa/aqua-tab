    ...
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div>
                    <span class="inline-block px-3 py-1 rounded-full text-xs font-semibold bg-green-50 text-green-700">
                        {{ $currentSubscription->plan->name }}
                    </span>
                    <p class="text-xs text-gray-500 mt-1">Expires {{ $currentSubscription->ends_at->format('M j, Y') }}</p>
                </div>
                @else
